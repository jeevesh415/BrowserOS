...
index deb531f8832e3..3b0569a578f43 100644
...
@@ -988,6 +990,31 @@ bool BrowserCommandController::ExecuteCommandWithDisposition(
...
@@ -1648,6 +1675,12 @@ void BrowserCommandController::InitCommandState() {
   }
